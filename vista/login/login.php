...
<div class="container mt-3">
    <form class="form-signin" id="tp5ej4-2" name="tp5ej4-2" action="../actions/actionLogin.php" method="post">
        <div class="login container col-md-3">
            ...
            <div class="d-grid mb-5 mt-3">
                <button class="btn" type="submit" style="color: white;background: rgb(0,212,255);background: linear-gradient(90deg, rgba(0,212,255,1) 0%, rgba(194,2,160,1) 0%, rgba(139,0,142,1) 100%);">Login</button>
            </div>
        </div>
    </form>
</div>
